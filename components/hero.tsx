...
export function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden pt-24 bg-gradient-to-br from-slate-700 via-blue-800/90 to-slate-700">
